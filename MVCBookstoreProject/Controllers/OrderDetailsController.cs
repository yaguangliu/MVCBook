...
namespace MVCBookstoreProject.Controllers
{
    public class OrderDetailsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "OrderDetailId,OrderId,BookId,Quantity")] OrderDetail orderDetail)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OrderDetailId,OrderId,BookId,Quantity")] OrderDetail orderDetail)
        {
            if (ModelState.IsValid)
            {
